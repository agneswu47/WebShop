...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 05, 2023 lúc 05:13 PM
...
INSERT INTO `bill` (`ID_Bill`, `ID_User`, `CreateDate`, `TotalMoney`, `VAT_rate`, `VAT_amount`, `TotalMoneyCheckout`, `Address_Bill`, `ID_BS`) VALUES
(12, 2, '2023-03-30 10:28:25', 2304910, 8, 0, 2489300, '123', 2),
(13, 2, '2023-03-30 11:09:51', 11560482, 8, 0, 12485300, 'YUIYUI', 1);
...
--
ALTER TABLE `bill_status`
  MODIFY `ID_BS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
